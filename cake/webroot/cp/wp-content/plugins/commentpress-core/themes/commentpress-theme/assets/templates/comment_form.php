...
<?php else : ?>
	...
	<form action="<?php echo '/cp/wp-comments-post.php'; //echo 'https://paulscholten.eu:1200/post_url.php?url=https://paulscholten.eu:1201/wp-comments-post.php'; ?>" method="post" id="commentform">
	...
	<fieldset id="author_details">
		...
		<?php if ( $user_ID ) : ?>
			...
			<p class="author_is_logged_in">Logged in as <a href="<?php echo get_option('siteurl'); ?>/wp-admin/profile.php"><?php echo $user_identity; ?></a> &rarr; <a href="<?php echo str_replace('/cp/','/research/',wp_logout_url('')).'&redirect_to=' . $_SERVER['HTTP_REFERER'];//JVDP ?>" title="Log out of this account">Log out</a></p>
