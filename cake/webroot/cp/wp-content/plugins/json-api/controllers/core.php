...
class JSON_API_Core_Controller {
  ...
  public function get_all_comments(){
  	global $json_api;
  	return $json_api->introspector->get_all_comments();
  }
  public function get_all_comments_json(){
  	global $json_api;
  	return $json_api->introspector->get_all_comments_json();
  }
  
  public function get_comments_by_commenter(){
  	global $json_api;
  	return $json_api->introspector->get_comments_by_commenter();  	
  }
  ...
  public function get_post() {
    ...
    extract($json_api->query->get(array('post_id', 'post_slug')));
    if ($id || $post_id) {
      if (!$id) {
        $id = $post_id;
      }
  ...
  public function get_page() {
    ...
    #var_dump($posts);exit();
    $posts[0]->content=preg_replace('/([^\'"])(https?:\/\/)([\da-z\.-]+)\.([a-z\.]{2,6})([\/\d-\+=&;%@.\w_?#]*)/i','$1<a href="$2$3.$4$5">$2$3.$4$5</a>',$posts[0]->content); //JVDP
