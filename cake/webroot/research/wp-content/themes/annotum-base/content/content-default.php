...
<article <?php post_class('article-full'); ?>>
	<header class="header">
		<div class="entry-title">
			...
			<tr>
				<td><img width="172" height="184" src="https://paulscholten.eu/cp/wp-content/uploads/2013/02/dpsp1.png"></td>
			
				<td><h1 class="title"><a rel="bookmark" href="<?php the_permalink() ?>"><?php the_title(); ?></a></h1></td>
			</tr>
			</table>
		</div>
		<div class="meta">
