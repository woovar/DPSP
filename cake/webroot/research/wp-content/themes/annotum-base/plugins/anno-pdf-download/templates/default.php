...
html,body{font-size: 12pt;text-align:justify;}
...
nav ol,nav ul{list-style-type:none;list-style:none;zoom:1}
nav{list-style-type:none;list-style:none;zoom:1}
...
nav ul,nav li{margin:0;list-style:none;list-style-image:none;list-style-type:none;display:inline;}
small{font-size:85%;}
...
.quote{background:#f6f6f6;border:0px solid #ddd;border-width:0px 0;padding:12px;margin:12px 0!important;}
...
.act .in{zoom:1;margin-left:auto;margin-right:auto;position:relative;}
.act .in:after{clear:both;}
#footer{padding-bottom:20px;}
#footer .in{border-top:#ddd solid 1px;padding-top:10px;}
#footer,#footer a{color:#787878;font-size:14pt!important;}
...
.article-full .header .entry-title .title{font:bold 24px;margin-bottom:5px;}
.article-full .header .entry-title .subtitle{font:bold 24px;margin-bottom:5px;}
.article-full .header .sec .title{display:block;}
.article-full .header .meta{color:#666;font:italic 13px/1.5384;margin:15px;padding:15px;}
...
.content blockquote{font:normal normal 12px;margin:10px;}
...
.content .alignleft{display:block;margin:0 auto 10px auto;}
...
.authors{font-size:18px!important;font-weight:bold;}
.author .extra a{display:inline;}
.author .extra .group{display:block;margin-bottom:5px;}
.author .extra{background:url(../img/author-card-background.png) -300px bottom no-repeat;font-size:16px;display:none;left:50%;margin-left:-119px;padding-bottom:10px;position:absolute;top:20px;width:248px;z-index:1000;}
...
<body <?php body_class(); ?>>
	...
	<?php echo Anno_PDF_Download::footer_markup(get_post_meta($post->ID, '_anno_page_number', true)); ?>
	</div>
</body>
</html>
