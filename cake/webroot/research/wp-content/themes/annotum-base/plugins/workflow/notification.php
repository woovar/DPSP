...
function annowf_send_notification($type, $post = null, $comment = null, $recipients = null, $single_user = null, $data = false) {
	...
	//$admin_email = get_option('admin_email');//JVDP
...
function annowf_notification_recipients($type, $post) {
	...
	switch ($type) {
		case 'submitted':
			$recipients = array_merge($recipients, annowf_get_role_emails('administrator', $post));//JVDP
			#$recipients = array_merge($recipients, annowf_get_role_emails('editor', $post));//JVDP
		case 're_review':
			$recipients = array_merge($recipients, annowf_get_role_emails('administrator', $post));//JVDP
			#$recipients = array_merge($recipients, annowf_get_role_emails('editor', $post));//JVDP
