...
function annowf_clone_post($orig_id) {
	...
	if ($new_id) {
		...
		update_post_meta($new_id, 'post_downloads_count', get_post_meta($orig_id, 'post_downloads_count', true));
		update_post_meta($new_id, 'post_views_count', get_post_meta($orig_id, 'post_views_count', true));
