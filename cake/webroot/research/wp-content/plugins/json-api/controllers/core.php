...
class JSON_API_Core_Controller {
	...
	public function get_article_category_index() {
		global $json_api;
		...
		$categories = $json_api->introspector->get_article_categories($slug);
		return array(
	...
	public function get_article() {
		...
		$article = $json_api->introspector->get_article($slug);
		return array(
				'article'=>$article
		);
	}	
	...
	public function get_articles_by_tag() {
		...
		$articles = $json_api->introspector->get_articles_by_tag($slug);
		return array(
				'articles'=>$articles
		);
	}	
	...
	public function get_article_category() {
		...
		$category = $json_api->introspector->get_article_category($slug);
		return array(
