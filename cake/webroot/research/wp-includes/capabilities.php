...
class WP_Roles {
	...
	function _init () {
		...
		$this->role_key = 'wp_user_roles';//JVDP
...
class WP_User {
	...
	function _init_caps( $cap_key = '' ) {
		...
		if ( empty($cap_key) )
			$this->cap_key = 'wp_capabilities';//JVDP
		else
	...
	function update_user_level_from_caps() {
		...
		update_user_meta( $this->ID, 'wp_user_level', $this->user_level );
	}
	...
	function remove_all_caps() {
		...
		delete_user_meta( $this->ID, 'wp_user_level' );//JVDP
		$this->get_role_caps();
	}
